...
function Carousel({
  ...
  return (
    ...
    >
      {/* biome-ignore lint/a11y/useSemanticElements: carousel region with aria-roledescription is the accepted embla/shadcn pattern */}
      <div
...
function CarouselItem({ className, ...props }: React.ComponentProps<"div">) {
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: slide group with aria-roledescription is the accepted embla/shadcn pattern
    <div
      role="group"
